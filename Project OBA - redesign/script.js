...
ORDER BY ?start
	...
	.then((resp) => resp.json()) // transform the data into json
  	.then(function(data) {
		...
		imgdiv = document.getElementById('mayor-list');
		console.log(rows);
...
// //////////////////////////////////////
    ...
    function filterResultaten(){
      ...
      let ul = document.getElementById('mayor-list');
...
document.getElementById("mayor-list").addEventListener("click", function(e) {
